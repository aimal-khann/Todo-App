      ...
      <AuroraCard className={`p-5 flex flex-col gap-3 h-full justify-between hover:bg-white/[0.04] transition-all duration-300`}>
        ...
        <div className="flex items-start gap-4 z-10 relative">
          ...
          <div className="flex-1 min-w-0">
            ...
            {task.description && (
              // FIX: Removed line-clamp, added break-words and whitespace-pre-wrap
              <p className={`text-xs text-white/50 mt-1 leading-relaxed break-words whitespace-pre-wrap`}>
                {task.description}
              </p>
            )}
