...
// --- 1. Icons (Exact Match from Register) ---
const Icons = {
...
// Exact "AuroraCard" from Register page
...
// Input styled exactly like Register page
...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
        const response = await apiClient.loginTyped(formData.email, formData.password);
  ...
  return (
    <div className="min-h-screen bg-[#020204] text-white font-sans selection:bg-indigo-500/30 flex overflow-hidden">
      ...
      {/* --- Exact Background from Register Page --- */}
      <div className="fixed inset-0 z-0 pointer-events-none">
        <div className="absolute top-[-20%] left-[-10%] w-[60vw] h-[60vw] bg-indigo-600/10 rounded-full blur-[120px] animate-pulse duration-[10000ms]"></div>
        <div className="absolute bottom-[-20%] right-[-10%] w-[50vw] h-[50vw] bg-purple-600/10 rounded-full blur-[120px] animate-pulse delay-2000 duration-[12000ms]"></div>
         ...
         >
            <AuroraCard className="p-8 md:p-10">
                <div className="text-center mb-8">
                   ...
                   <p className="text-white/40 text-sm mt-1">Enter your details to continue</p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                   ...
                   <div className="pt-4">
                      ...
                      >
                        {status === 'loading' ? 'Signing in...' : status === 'success' ? 'Welcome Back!' : (
                   ...
                   <p className="text-center text-white/40 text-xs pt-4 font-medium">
                      Don't have an account? <Link href="/register" className="text-white hover:text-indigo-400 transition-colors">Sign up</Link>
                   </p>
                </form>
            </AuroraCard>
         </motion.div>
